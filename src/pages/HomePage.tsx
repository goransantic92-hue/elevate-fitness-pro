...
import { ArrowRight, Clock, Calendar, Timer, Users, Dumbbell, Utensils, Target, ChevronRight, Star } from "lucide-react";
...
const testimonials = [
  { name: "Marco D.", age: 38, role: "Entrepreneur", text: "I've tried dozens of programs. This is the first one I actually finished. Down 8kg, up on every lift.", rating: 5 },
  { name: "Sarah K.", age: 42, role: "Working Mom", text: "30 minutes, 3 days a week. That's all it took. I feel stronger than I did in my 20s.", rating: 5 },
  { name: "James R.", age: 45, role: "Executive", text: "The nutrition framework alone was worth it. No counting, no apps. Just results.", rating: 5 },
];
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {testimonials.map((t) => (
              <div key={t.name} className="glass-card p-8">
                ...
                <div>
                  <p className="font-bold text-sm">{t.name}, {t.age}</p>
